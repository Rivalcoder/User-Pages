  ...
  return (
    <>
      <div className="min-h-screen bg-gray-200 ">
        ...
        <div className='absolute flex flex-col justify-between items-center    bg-white min-h-screen w-20 top-0'>
          ...
          <button className='text-5xl m-2 mb-5 '><IoIosLogOut  color='red' className=' hover:bg-green-100 rounded-lg p-2' /></button>
        </div>
        {/*NavBar Area */ }
        <div className='bg-white mt-8 ml-56 mr-5  gap-5 justify-center items-center  rounded-lg w-3/4 '>
          <ul className='flex flex-row  p-2 '>
            <li className='flex flex-row justify-center items-center gap-5 px-20 py-2  rounded-lg font-semibold text-xl hover:bg-green-800 hover:text-white'><FaUsers />Users</li>
            <li className='flex flex-row justify-center items-center gap-5 px-20 py-2  rounded-lg font-semibold text-xl hover:bg-green-800 hover:text-white'><PiCirclesThreeLight />Roles</li>
            <li className='flex flex-row justify-center items-center gap-5 px-20 py-2  rounded-lg font-semibold text-xl hover:bg-green-800 hover:text-white'><SiAwsorganizations  />Infrasture</li>
            <li className='flex flex-row justify-center items-center gap-5 px-20 py-2  rounded-lg font-semibold text-xl hover:bg-green-800 hover:text-white'><RiCalendarScheduleLine />Schedules</li>
          </ul>
        </div>
